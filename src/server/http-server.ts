...
import { getCurrentRundownItem, getMusicChannel, getRundown, setCurrentRundownItem } from './settings';
        ...
        sendServerMessage(
          {
            type: 'rundown',
            rundown: getRundown(),
            currentItem: getCurrentRundownItem(),
          },
          ws
        );
        ws.on('message', (message) => {
          try {
            ...
            switch (msg.type) {
              ...
              case 'f': {
                setFaderLevel(getMusicChannel(), msg.l);
                break;
              }
              case 'set-rundown-item': {
                setCurrentRundownItem(msg.item);
                break;
              }
              default:
